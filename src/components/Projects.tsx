...
const Card = ({ project, index, progress, total }: CardProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="rounded-3xl sm:rounded-2xl overflow-hidden border-2 border-white/80 bg-black/5 mt-4 relative shadow-[inset_0_2px_10px_rgba(0,0,0,0.05)] p-3 sm:p-6 pointer-events-none">
        {project.coverImage ? (
          <img
