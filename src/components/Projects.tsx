...
const Card = ({ project, index, total }: { project: any, index: number, total: number }) => {
  ...
  return (
    // Wrapper gives each card equal scroll runway so they all unstick at the same time
    <div className="h-[85vh]">
      ...
      >
        ...
        <div className="mt-4 flex flex-col gap-6">
          <p className="text-gray-700 leading-relaxed text-sm font-mono line-clamp-2">{project.description}</p>
          <Link 
