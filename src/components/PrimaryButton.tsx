...
const BASE =
  "group items-center justify-center gap-2 max-w-full bg-primary text-white py-4 rounded-[1.25rem] font-black text-sm uppercase tracking-widest " +
...
export function PrimaryButton({ fullWidth, children, ...rest }: Props) {
  // Non-fullWidth becomes responsive: full-width on mobile so long content
  // (e.g. email addresses) doesn't overflow the viewport, inline on desktop.
